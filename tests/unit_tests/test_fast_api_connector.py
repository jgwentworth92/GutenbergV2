...
from dataflow_connectors.HTTP_connector import HTTPSink, HTTPConnector



def test_fastapi_connector_initialization(sample_url, sample_auth_header, sample_prepare_payload):
    connector = HTTPConnector(sample_url, sample_auth_header, sample_prepare_payload)
...
def test_fastapi_sink_initialization(sample_url, sample_auth_header, sample_prepare_payload):
    sink = HTTPSink(sample_url, sample_auth_header, sample_prepare_payload)
